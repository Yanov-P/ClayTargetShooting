...
public class MainPanelInput : MonoBehaviour, IEndDragHandler, IDragHandler, IBeginDragHandler, IPointerDownHandler, IPointerUpHandler
{
    [SerializeField]
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (_offset.x < -80) _player.LeftSwipe();
